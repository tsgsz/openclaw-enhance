# Validation Report: harness-routing-evidence
...
```bash
python -m openclaw_enhance.validation.live_probes routing-yield --openclaw-home "$OPENCLAW_HOME" --workspace oe-orchestrator
```
...
**stdout:**
```
{"marker": "PROBE_ROUTING_YIELD_OK", "ok": true, "probe": "routing-yield", "proof": "sessions_yield", "workspace": "oe-orchestrator"}
```
