...
```bash
cd /Users/tsgsz/workspace/openclaw-enhance && pytest tests/integration/test_orchestrator_dispatch_contract.py::TestOrchestratorRecoveryFlow::test_websearch_not_found_recovery_executable -xvs
```
...
```
==================================================================================================================== test session starts ====================================================================================================================
platform darwin -- Python 3.13.12, pytest-9.0.2, pluggy-1.6.0 -- /opt/homebrew/Caskroom/miniconda/base/envs/jupyterlab313/bin/python3.13
...
tests/integration/test_orchestrator_dispatch_contract.py::TestOrchestratorRecoveryFlow::test_websearch_not_found_recovery_executable PASSED
